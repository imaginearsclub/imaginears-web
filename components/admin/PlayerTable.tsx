...
const PlayerRow = memo(function PlayerRow({
    ...
    const safeServer = useMemo(() => sanitizeString(player.server), [player.server]);
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="space-y-2 text-sm">
                                        <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                                            ...
                                            <span>Currently in: <strong>{safeServer}</strong></span>
                                        </div>
                                        <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400">
...
const PlayerTable = memo(function PlayerTable({
    ...
    const { filteredData, filterQuery, setFilterQuery } = useTableFilter(sortedData, (player, query) => {
        ...
        return (
            ...
            player.server.toLowerCase().includes(q)
        );
    });
    ...
    return (
        <>
            ...
            <div className="mb-4">
                <Input
                    type="text"
                    placeholder="Search players by name, rank, or server..."
                    value={filterQuery}
