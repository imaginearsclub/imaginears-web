export default function Footer() {
  ...
  return (
    <footer
      ...
      className="mt-16 border-t border-slate-200/60 dark:border-slate-800/60 bg-gradient-to-tr from-brandStart/15 via-white/85 to-brandEnd/15 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900"
      role="contentinfo"
    >
